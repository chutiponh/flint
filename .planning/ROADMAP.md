...
Plans:
- [x] 07-01-PLAN.md — Eyedropper re-present + NSColorPanel falling-edge watchdog (both pickers keep the popover usable, D-04) + paste-back-dismiss guard + manual UAT gate
